...
import TestGoban from './components/TestGoban/TestGoban.js';
...
function AlphaGo() {
  ...
  return (
    <div className="AlphaGo">
      <NavBar></NavBar>
      <div id='TestVisualizer' style={{ display: 'flex', flexDirection: 'row', justifyContent: 'spaceBetween', alignItems: 'center' }}>
        <Goban playground={true}></Goban>
        <TestGoban testBoard={testBoard}></TestGoban>
      </div>
